...
var e = {
  ...
  choicesSelect() {
    ...
    elements.forEach((element) => {
      const removeItemBtn = element.getAttribute('data-remove-item-button') === 'true';
      const placeHolder = element.getAttribute('data-placeholder') !== 'false';
      const placeHolderVal = element.getAttribute('data-placeholder-val') || 'Type and hit enter';
      const maxItemCount = parseInt(element.getAttribute('data-max-item-count') || '3', 10);
      const searchEnabled = element.getAttribute('data-search-enabled') === 'true';
      ...
      const choices = new Choices(element, {
        ...
        searchEnabled: searchEnabled,
        shouldSort: false,
        // Add any other options you need for Choices.js initialization
      });
      console.log(choices);
    });
  },
